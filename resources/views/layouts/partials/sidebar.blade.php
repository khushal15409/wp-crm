...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @if($isSuperAdmin)
            <li class="dropdown"><a href="{{ route('leads.create') }}" class="nav-link"><i data-feather="user-plus"></i><span>Add Lead</span></a></li>
            @endif
            <li class="dropdown {{ request()->routeIs('pipeline.*') ? 'active' : '' }}">
                <a href="{{ route('pipeline.index') }}" class="nav-link"><i data-feather="trending-up"></i><span>Pipeline</span></a>
            </li>
            <li class="dropdown {{ request()->routeIs('follow-ups.*') ? 'active' : '' }}">
                <a href="{{ route('follow-ups.index') }}" class="nav-link"><i data-feather="clock"></i><span>Follow-ups</span></a>
            </li>
            ...
            @if(!$isSuperAdmin)
            <li class="dropdown {{ request()->routeIs('subscriptions.*') ? 'active' : '' }}">
                <a href="{{ route('subscriptions.index') }}" class="nav-link"><i data-feather="credit-card"></i><span>Subscription</span></a>
            </li>
            @endif
            ...
            <li class="dropdown {{ request()->routeIs('settings.*') ? 'active' : '' }}">
                <a href="{{ route('settings.index') }}" class="nav-link"><i data-feather="settings"></i><span>System Settings</span></a>
            </li>
            ...
            <li class="dropdown {{ request()->routeIs('roles.*') ? 'active' : '' }}">
                <a href="{{ route('roles.index') }}" class="nav-link"><i data-feather="shield"></i><span>Roles</span></a>
            </li>
            <li class="dropdown {{ request()->routeIs('permissions.*') ? 'active' : '' }}">
                <a href="{{ route('permissions.index') }}" class="nav-link"><i data-feather="lock"></i><span>Permissions</span></a>
            </li>
            @endif
        </ul>
    </aside>
