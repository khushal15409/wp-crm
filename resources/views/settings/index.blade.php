...
@section('page_subtitle', 'Configure system-wide settings, integrations, and payments.')
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('settings.update') }}" method="POST">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#settings-general" role="tab">General Settings</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#settings-whatsapp" role="tab">WhatsApp Integration</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#settings-payments" role="tab">Payment Gateway</a>
                        </li>
                    </ul>
